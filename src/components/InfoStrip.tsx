  ...
  return (
    ...
    >
      <p className="flex items-center justify-center gap-2 t-caption font-semibold lg:font-normal lg:text-themeText2">
        <img src="/icons/location.svg" alt="" aria-hidden width={16} height={16} className="block shrink-0 w-4 h-4" />
      ...
      <p className="flex items-center justify-center gap-2 pt-2 lg:pt-0 t-caption text-themeText2">
        <img src="/icons/clock.svg" alt="" aria-hidden width={16} height={16} className="block shrink-0 w-4 h-4" />
        <span>שישי 10:00–18:00 | הזמנות עד 16:30 ביום שישי</span>
      </p>
      <p className="flex items-center justify-center gap-2 pt-2 lg:pt-0 t-caption text-themeText2">
        <img src="/icons/sparkle.svg" alt="" aria-hidden width={16} height={16} className="block shrink-0 w-4 h-4" />
